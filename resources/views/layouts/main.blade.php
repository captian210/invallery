    ...
    <div class="container px-lg-0">
        ...
        <div class="navbar-translate">
            <a class="navbar-brand svg" href="/" rel="tooltip"
               title="" data-placement="bottom">
                ...
                <object type="image/svg+xml" data="/svg/muts.svg"
                        style="width: 82.77px; height: 55px; margin-bottom: 6px; margin-right: 0.75rem; vertical-align: middle;"
                        onclick="location.href='/';" >
        ...
        <div class="collapse navbar-collapse justify-content-end" data-nav-image="..//img/blurred-image-1.jpg">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $navItem == 'brand' ? 'active' : '' }}" href="/brand">Brand Links</a>
                </li>
...
<h6 class="small mb-4">Recent Blog Articles</h6>
    &#183; <a style="color:#e3c797;" href="https://blog.invalley.com/how-to-utilize-powerful-qa-links-for-link-building">Case Study: How To Utilize Powerful Q&A Links For Link Building</a>
    <br /><br />
    &#183; <a style="color:#e3c797;" href="https://blog.invalley.com/how-we-helped-a-fortune-500-company">How We Helped A Fortune 500 Company</a>
</div>
</div>
    </div>
</footer>
